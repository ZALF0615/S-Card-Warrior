...
window.gameLogic = {
    ...
    draw: gameLogicDraw,
    keyPressed: gameLogicKeyPressed,
    preload: gameLogicPreload,
    displayPlayerInfo: displayPlayerInfo,
    displaySelectedaction: displaySelectedaction,
    ...
    AttackVSCounter: AttackVSCounter,
    AttackVSBlock: AttackVSBlock,
    SpecialVSBlock: SpecialVSBlock,
    SpecialVSCounter: SpecialVSCounter,
    getActionImage: getActionImage,
    Effect: Effect,
    TurnTaker: TurnTaker,
    actionSelected: actionSelected,
    imageCenter: imageCenter,
    imageButtom: imageButtom,
    FloatUI: FloatUI
  };