...
function displayAction(x, y, playerNum) {
    ...
    tint(255);
    imageCenter(playerNum == 1 ? input_button_S : input_button_DOWN, x, y + 75);
    ...
    imageCenter(playerNum == 1 ? input_button_A : input_button_LEFT, x - 135, y + 100 - 75);
    fill('green');
    text(playerNum == 1 ? player1.scissors : player2.scissors, x - 135 + 50, y + 100 + 30);

    imageCenter(command_rock, x, y - 160); // 바위
    imageCenter(playerNum == 1 ? input_button_W : input_button_UP, x, y - 160 - 75);
    fill('red');
    text(playerNum == 1 ? player1.rock : player2.rock, x + 50, y - 160 + 30);

    imageCenter(command_paper, x + 135, y + 100); // 보
    imageCenter(playerNum == 1 ? input_button_D : input_button_RIGHT, x + 135, y + 100 - 75);
    fill('blue');
