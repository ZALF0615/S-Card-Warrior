...
//additional
let player_Info_BG;
let turn_ATTACK_icon;
let turn_DEFENSE_icon
let action_DEFAULT;

//
let player1_CharacterSheet;
let player2_CharacterSheet;
...
function preload() {
  ...
  sage_images.push(loadImage('Asset/Character/현자_기본.gif'));
  sage_images.push(loadImage('Asset/Character/현자_준비.gif'));
  sage_images.push(loadImage('Asset/Character/현자_데미지.gif'));
  sage_images.push(loadImage('Asset/Character/현자_공격.gif'));
  sage_images.push(loadImage('Asset/Character/현자_방어.gif'));
  sage_images.push(loadImage('Asset/Character/현자_카운터.gif'));
  sage_images.push(loadImage('Asset/Character/현자_필살.gif'));
  sage_images.push(loadImage('Asset/Character/현자_특수스킬.gif'));
  sage_images.push(loadImage('Asset/Character/현자_승리.gif'));
  sage_images.push(loadImage('Asset/Character/현자_패배.gif'));

  // 마법사 (기본, 준비, 데미지, 공격, 방어, 카운터, 필살, 특수스킬, 승리, 패배)
  mage_images.push(loadImage('Asset/Character/마법사_기본.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_준비.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_데미지.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_공격.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_방어.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_카운터.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_필살.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_특수스킬.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_승리.gif'));
  mage_images.push(loadImage('Asset/Character/마법사_패배.gif'));
